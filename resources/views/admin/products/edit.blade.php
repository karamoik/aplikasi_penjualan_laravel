    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-titel"> Edit Products</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::select('category_id',[null=>'Choose Category'] + $categories, null,
                        ['class'=>'form-control']) !!}
                    </div>
                    <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::file('image', ['class'=>'form-control','placeholder'=>'Choose Image...']) !!}
                    </div>
            ...
            <div class="card-footer">
                ...
                <button class="btn btn-primary float-right" type="submit"><i class="fa fa-save"></i>Update</button>
            </div>
            {!! Form::close() !!}
        </div>
    </div>
