            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-sm-4">
                        ...
                        {!! Form::select('category', $categories, $category, ['class' => 'form-control', 'placeholder'
                        => 'Choose Category']) !!}
                    </div>
                    <div class="form-group col-sm-4">
                    ...
                    <div class="form-group col-sm-4" style="margin-top: 3.2%">
                        <label for="">&nbsp;</label>
                        <button type="submit" class="btn btn-primary"><i class="fa fa-search"></i> Search</button>
                        <a href="{{ route('products.index') }}" class="btn btn-outline-secondary"><i
                                class="fa fa-sync"></i> Reload</a>
                    </div>
                </div>
                {!! Form::close() !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group" role="group" aria-label="Button group">
                                        <a href="{{ route('products.show', $item->id) }}" class="btn btn-sm btn-info"
                                        ...
                                        <button type="submit" class="btn btn-sm btn-danger"
                                            onclick="return confirm('Are you sure ?')" style="color: #fff"><i
